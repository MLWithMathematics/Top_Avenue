...
## Corpus Check
- 18 files · ~26,079 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 48 nodes · 36 edges · 16 communities detected
...
3. `run()` - 3 edges
4. `seed()` - 2 edges
5. `testConnection()` - 2 edges
6. `computeNights()` - 2 edges
7. `BookingFlow()` - 2 edges

## Surprising Connections (you probably didn't know these)
- `seed()` --calls--> `log()`  [INFERRED]
  D:\Antigravity\TopAvenue\seedRooms.js → D:\Antigravity\TopAvenue\scripts\health-check.js
- `testConnection()` --calls--> `log()`  [INFERRED]
  D:\Antigravity\TopAvenue\testSupabase.js → D:\Antigravity\TopAvenue\scripts\health-check.js
...
- **Thin community `Community 8`** (2 nodes): `Home.jsx`, `Home()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
